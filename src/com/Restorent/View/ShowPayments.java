...
public class ShowPayments extends JFrame {
	...
	public ShowPayments(){
	    ...
	    String  payment_Id,order_Id,amount,payment_date,payment_method;
	     ...
	     while(rs.next())   {
	    	 ...
	    	 payment_date = rs.getString(4);
	    	 payment_method = rs.getString(5);
	    	 
		String row[]= {payment_Id,order_Id,amount,payment_date,payment_method};
	       	 model.addRow(row); 
	     }	 
	         }
	         catch(Exception e) {
